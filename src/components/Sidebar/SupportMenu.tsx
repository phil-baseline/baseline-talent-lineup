    ...
    <div ref={menuRef} className="relative">
      {isOpen && (
        ...
        >
          ...
          {/* Action links */}
          <div className="p-3 space-y-1 border-t border-brown/5">
            {/* Email with copy button */}
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg text-deep-brown/80 hover:bg-cream transition-all group">
              <div className="w-7 h-7 rounded-full bg-sage/10 flex items-center justify-center group-hover:bg-sage/20 transition-colors shrink-0">
                <svg className="w-3.5 h-3.5 text-sage" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <div className="flex-1 min-w-0">
                <span className="text-sm font-medium block truncate">{CONTACT_EMAIL}</span>
              </div>
              <button
                onClick={handleCopyEmail}
                className="relative p-1.5 text-stone hover:text-sage hover:bg-sage/10 transition-all rounded-md shrink-0"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-deep-brown/80 hover:bg-cream hover:text-deep-brown transition-all group"
            >
              <div className="w-7 h-7 rounded-full bg-amber-500/10 flex items-center justify-center group-hover:bg-amber-500/20 transition-colors shrink-0">
            ...
            <a
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-deep-brown/80 hover:bg-cream hover:text-deep-brown transition-all group"
            >
              <div className="w-7 h-7 rounded-full bg-moss/10 flex items-center justify-center group-hover:bg-moss/20 transition-colors shrink-0">
                <svg className="w-3.5 h-3.5 text-moss" fill="none" viewBox="0 0 24 24" stroke="currentColor">
